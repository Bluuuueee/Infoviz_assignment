...
import styles from '../src/styles/assignment5_styles.module.css';

import { groupByAirline, groupByAirport } from "../src/components/assignment5/utils";
import { AirportMap } from "../src/components/assignment5/airportMap";
import { BarChart } from "../src/components/assignment5/barChart";
...
function AirlineRoutes() {
    ...
    return (
        <Container>
            <Row className={`justify-content-md-left ${styles.titleBackground}`}>
                <Col lg={10}>
                    <h1 className={styles.title} class={styles.h1Style}>Airlines Routes</h1>
                </Col>
            </Row>
            <Row className={"justify-content-md-left"}>
                <Col lg={4}>
                    <h2>Airlines</h2>
                    <svg id={"barchart"} class={styles.svgStyle} width={barchart_width} height={barchart_height}>
                ...
                <Col lg={4}>
                    <h2>Airports</h2>
                    <svg id={"map"} class={styles.svgStyle} width={map_width} height={map_height}>
